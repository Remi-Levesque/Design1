...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Assurer la précision et l'exactitude du logiciel de reconnaissance 
        \item Faciliter l'utilisation de l'interface
        \item Maximiser les variétés de poissons identifiables
        \item Maximiser la capacité de stockage des données
        \item Renforcer la fiabilité du système de sécurité
    \end{itemize}
